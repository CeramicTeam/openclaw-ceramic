"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _pluginEntry = require("openclaw/plugin-sdk/plugin-entry");
...
function getCeramicMcpClient(apiKey) {
  ...
  if (!clientPromise) {
    clientPromise = (async () => {
      const transport = new _streamableHttp.StreamableHTTPClientTransport(new URL(CERAMIC_MCP_URL), {
        requestInit: { headers: { Authorization: `Bearer ${apiKey}` } }
      });
      const client = new _index.Client({ name: "openclaw-ceramic-search", version: "2.0.0" }, { capabilities: {} });
...
var index_default = exports.default = (0, _pluginEntry.definePluginEntry)({
  id: "ceramic-search",
  name: "Ceramic Search",
